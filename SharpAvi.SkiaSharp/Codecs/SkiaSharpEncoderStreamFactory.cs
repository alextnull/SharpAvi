...
namespace SharpAvi.Codecs
{
    ...
    public static class SkiaSharpEncoderStreamFactory
    {
        ...
        public static IAviVideoStream AddMJpegSkiaSharpVideoStream(this AviWriter writer, int width, int height, int quality = 70)
        {
            ...
            var encoder = new MJpegSkiaSharpVideoEncoder(width, height, quality);
